...
Официальные документы Lesta Games:
...
В библиотеке реализованы основные функции API Lesta Games. Все запросы делаются через ваше приложение, которое вы заранее создали на [этой](https://developers.lesta.ru/applications/) странице. Некоторые функции перечислены ниже:
...
__version__ = "0.1.0"
__license__ = "MIT"
__apiholder__ = "Lesta Games <https://lesta.ru>"